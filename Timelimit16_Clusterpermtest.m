...
% chans = {'EEG038','EEG039','EEG040','EEG041','EEG045','EEG046','EEG047','EEG048','EEG049','EEG050','EEG051','EEG053','EEG054','EEG055','EEG056','EEG057','EEG058','EEG059','EEG060'}; %{'EEG028'};
                ...
                for subi=1:nSubjs;
                    ...
                    templateTFR.powspctrm = R_all{subi}.powspctrm;
                    R_contr{subi}= templateTFR;
                    R_contr{subi}.powspctrm= zeros(nChans,nFreqs,nTimes)
                    
%                     for condi = 1:length(uconds)
%
%                         templateTFR{condi}.powspctrm = B_all{subi,condi}.powspctrm;
%                         B_contr{subi,condi}= templateTFR{condi};
%                         B_contr{subi,condi}.powspctrm= zeros(nChans,nFreqs,nTimes);
%
%                     end
                ...
                for subi=1:nSubjs;
                    ...
                    templateTFR.powspctrm = B_all{subi}.powspctrm;
                    B_contr{subi}= templateTFR;
                    B_contr{subi}.powspctrm= zeros(nChans,nFreqs,nTimes)
...
%                 cfg.neighbours = neighbs;
                ...
                stat = ft_freqstatistics(cfg, B_all{:}, B_contr{:});
